...
const LeftPanel = {
  template: `
    <div class="mvu-vue-wrapper" :class="{ 'is-folded': isFolded }" style="position: fixed; top: 0; left: 0; bottom: 0; z-index: 100;">
...
const RightPanel = {
  template: `
    <div class="mvu-vue-wrapper" :class="{ 'is-folded': isFolded }" style="position: fixed; top: 0; right: 0; bottom: 0; z-index: 100;">
