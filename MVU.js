...
const MVU_RUNTIME_UPDATE_PLACEHOLDER_V1 = '{{MVU_RUNTIME_UPDATE}}';
const MVU_UPDATE_STRUCTURE_HINTS_PLACEHOLDER_V1 = '{{MVU_UPDATE_STRUCTURE_HINTS}}';

const MVU正文视图排除路径模板_V1 = ["当前","当前.地点","当前.时间","当前.时间._上次结算tick","当前.时间._calendar","当前.时间.tick","当前.玩家","当前.玩家行动","当前.系统播报","剧情钩子","剧情钩子._引导","剧情钩子._引导.时间线预览","剧情钩子.机密情报","剧情钩子.机密情报.示例情报","剧情钩子.机密情报.示例情报.标题","剧情钩子.机密情报.示例情报.内容","剧情钩子.交易请求","剧情钩子.拍卖","剧情钩子.拍卖.地点","剧情钩子.委托板","剧情钩子.委托板.示例委托","剧情钩子.委托板.示例委托.标题","剧情钩子.委托板.示例委托.类型","剧情钩子.委托板.示例委托.描述","剧情钩子.战斗","物品.示例物品.基础耐久","物品.示例物品.阶位","物品.示例物品.使用效果","物品.示例物品.使用效果.[]","物品.示例物品.使用效果.[].持续tick","物品.示例物品.使用效果.[].描述","物品.示例物品.使用效果.[].目标","物品.示例物品.使用效果.[].属性","物品.示例物品.使用效果.[].数值","物品.示例物品.使用效果.[].原型","物品.示例物品.属性加成","物品.示例物品.属性加成.示例项","物品.示例物品.装备槽位","物品.示例物品.装备技能","物品.示例物品.装备技能.示例项","物品.示例物品.装备技能.示例项._效果数组","物品.示例物品.装备技能.示例项._效果数组.[]","物品.示例物品.装备技能.示例项.附带属性","物品.示例物品.装备技能.示例项.附带属性.[]","物品.示例物品.装备技能.示例项.画面描述","物品.示例物品.装备技能.示例项.魂技名","物品.示例物品.装备技能.示例项.机制决策临时","物品.示例物品.装备技能.示例项.技能掌控度","物品.示例物品.装备技能.示例项.技能掌控度.圆满等级","物品.示例物品.装备技能.示例项.技能掌控度.中心等级","物品.示例物品.装备技能.示例项.前摇","物品.示例物品.装备技能.示例项.消耗","物品.示例物品.装备技能.示例项.效果描述","相关实体索引","相关实体索引.角色","相关实体索引.角色.[]","相关实体索引.命物品","相关实体索引.命物品.[]","相关实体索引.命中地点","相关实体索引.命中地点.[]","相关实体索引.命中动态地点","相关实体索引.命中动态地点.[]","相关实体索引.命中势力","相关实体索引.命中势力.[]","char.示例角色.__mvu_isPlayer","char.示例角色.第一武魂.第1魂灵.品质","char.示例角色.第一武魂.可容纳属性","char.示例角色.第一武魂.可容纳属性.[]","char.示例角色.第一武魂.属性体系","char.示例角色.魂骨.示例项.附带技能.示例项","char.示例角色.魂骨.示例项.附带技能.示例项._效果数组","char.示例角色.魂骨.示例项.附带技能.示例项._效果数组.[]","char.示例角色.魂骨.示例项.附带技能.示例项.附带属性","char.示例角色.魂骨.示例项.附带技能.示例项.附带属性.[]","char.示例角色.魂骨.示例项.附带技能.示例项.机制决策临时","char.示例角色.魂骨.示例项.附带技能.示例项.技能掌控度","char.示例角色.魂骨.示例项.附带技能.示例项.技能掌控度.圆满等级","char.示例角色.魂骨.示例项.附带技能.示例项.技能掌控度.中心等级","char.示例角色.魂骨.示例项.附带技能.示例项.前摇","char.示例角色.魂骨.示例项.附带技能.示例项.消耗","char.示例角色.魂骨.示例项.属性加成","char.示例角色.魂骨.示例项.属性加成.防御","char.示例角色.魂骨.示例项.属性加成.魂力上限","char.示例角色.魂骨.示例项.属性加成.精神力上限","char.示例角色.魂骨.示例项.属性加成.力量","char.示例角色.魂骨.示例项.属性加成.敏捷","char.示例角色.魂骨.示例项.属性加成.体力上限","char.示例角色.魂骨.示例项.状态","char.示例角色.晋升请求","char.示例角色.晋升请求.目标势力","char.示例角色.晋升请求.目标职位","char.示例角色.捐献请求","char.示例角色.捐献请求.目标势力","char.示例角色.捐献请求.数量","char.示例角色.捐献请求.物品名称","char.示例角色.社交.称号.示例项.声望加成","char.示例角色.社交.公开情报","char.示例角色.社交.势力.示例势力.权限级","char.示例角色.属性.背景","char.示例角色.属性.背景阶层","char.示例角色.属性.等级惩罚","char.示例角色.属性.底子波动","char.示例角色.属性.防御","char.示例角色.属性.魂力","char.示例角色.属性.魂力上限","char.示例角色.属性.基础魂力上限","char.示例角色.属性.精神境界","char.示例角色.属性.精神力","char.示例角色.属性.精神力上限","char.示例角色.属性.力量","char.示例角色.属性.敏捷","char.示例角色.属性.上次灵物等级","char.示例角色.属性.体力","char.示例角色.属性.体力上限","char.示例角色.属性.天赋评级","char.示例角色.属性.天赋梯队","char.示例角色.属性.突破魂力上限","char.示例角色.属性.训练加成","char.示例角色.属性.训练加成.防御","char.示例角色.属性.训练加成.精神力上限","char.示例角色.属性.训练加成.力量","char.示例角色.属性.训练加成.敏捷","char.示例角色.属性.训练加成.体力上限","char.示例角色.属性.永久魂力加成","char.示例角色.属性.状态效果","char.示例角色.属性.状态效果.示例项","char.示例角色.属性.状态效果.示例项.层数","char.示例角色.属性.状态效果.示例项.持续回合","char.示例角色.属性.状态效果.示例项.类型","char.示例角色.属性.状态效果.示例项.面板倍率","char.示例角色.属性.状态效果.示例项.面板倍率.防御","char.示例角色.属性.状态效果.示例项.面板倍率.魂力上限","char.示例角色.属性.状态效果.示例项.面板倍率.力量","char.示例角色.属性.状态效果.示例项.面板倍率.敏捷","char.示例角色.属性.状态效果.示例项.描述","char.示例角色.属性.状态效果.示例项.战斗效果","char.示例角色.属性.状态效果.示例项.战斗效果.持续伤害","char.示例角色.属性.状态效果.示例项.战斗效果.破防比例","char.示例角色.属性.状态效果.示例项.战斗效果.跳过回合","char.示例角色.属性.HP","char.示例角色.属性.HP上限","char.示例角色.武魂融合技.示例项","char.示例角色.武魂融合技.示例项.技能数据","char.示例角色.武魂融合技.示例项.技能数据._效果数组","char.示例角色.武魂融合技.示例项.技能数据._效果数组.[]","char.示例角色.武魂融合技.示例项.技能数据.附带属性","char.示例角色.武魂融合技.示例项.技能数据.附带属性.[]","char.示例角色.武魂融合技.示例项.技能数据.机制决策临时","char.示例角色.武魂融合技.示例项.技能数据.技能掌控度","char.示例角色.武魂融合技.示例项.技能数据.技能掌控度.圆满等级","char.示例角色.武魂融合技.示例项.技能数据.技能掌控度.中心等级","char.示例角色.武魂融合技.示例项.技能数据.前摇","char.示例角色.武魂融合技.示例项.技能数据.消耗","char.示例角色.血脉之力.被动.示例项._效果数组","char.示例角色.血脉之力.被动.示例项._效果数组.[]","char.示例角色.血脉之力.被动.示例项.附带属性","char.示例角色.血脉之力.被动.示例项.附带属性.[]","char.示例角色.血脉之力.被动.示例项.机制决策临时","char.示例角色.血脉之力.被动.示例项.技能掌控度","char.示例角色.血脉之力.被动.示例项.技能掌控度.圆满等级","char.示例角色.血脉之力.被动.示例项.技能掌控度.中心等级","char.示例角色.血脉之力.被动.示例项.前摇","char.示例角色.血脉之力.被动.示例项.消耗","char.示例角色.血脉之力.技能.示例项","char.示例角色.血脉之力.技能.示例项._效果数组","char.示例角色.血脉之力.技能.示例项._效果数组.[]","char.示例角色.血脉之力.技能.示例项.附带属性","char.示例角色.血脉之力.技能.示例项.附带属性.[]","char.示例角色.血脉之力.技能.示例项.机制决策临时","char.示例角色.血脉之力.技能.示例项.技能掌控度","char.示例角色.血脉之力.技能.示例项.技能掌控度.圆满等级","char.示例角色.血脉之力.技能.示例项.技能掌控度.中心等级","char.示例角色.血脉之力.技能.示例项.前摇","char.示例角色.血脉之力.技能.示例项.消耗","char.示例角色.血脉之力.永久加成","char.示例角色.血脉之力.永久加成.示例项","char.示例角色.血脉之力.永久加成.示例项.来源层级","char.示例角色.血脉之力.永久加成.示例项.属性加成","char.示例角色.血脉之力.永久加成.示例项.属性加成.防御","char.示例角色.血脉之力.永久加成.示例项.属性加成.魂力上限","char.示例角色.血脉之力.永久加成.示例项.属性加成.精神力上限","char.示例角色.血脉之力.永久加成.示例项.属性加成.力量","char.示例角色.血脉之力.永久加成.示例项.属性加成.敏捷","char.示例角色.血脉之力.永久加成.示例项.属性加成.体力上限","char.示例角色.血脉之力.永久加成.示例项.效果描述","char.示例角色.血脉之力.永久加成.示例项.状态","char.示例角色.装备.斗铠._属性加成","char.示例角色.装备.斗铠._属性加成.等效等级","char.示例角色.装备.斗铠._属性加成.防御","char.示例角色.装备.斗铠._属性加成.魂力上限","char.示例角色.装备.斗铠._属性加成.精神力上限","char.示例角色.装备.斗铠._属性加成.力量","char.示例角色.装备.斗铠._属性加成.敏捷","char.示例角色.装备.斗铠._属性加成.体力上限","char.示例角色.装备.斗铠._已排异","char.示例角色.装备.斗铠.部件","char.示例角色.装备.斗铠.部件.示例项","char.示例角色.装备.斗铠.部件.示例项.品质系数","char.示例角色.装备.斗铠.部件.示例项.状态","char.示例角色.装备.机甲","char.示例角色.装备.机甲._属性加成","char.示例角色.装备.机甲._属性加成.防御","char.示例角色.装备.机甲._属性加成.魂力上限","char.示例角色.装备.机甲._属性加成.精神力上限","char.示例角色.装备.机甲._属性加成.力量","char.示例角色.装备.机甲._属性加成.敏捷","char.示例角色.装备.机甲._属性加成.体力上限","char.示例角色.装备.机甲.品质系数","char.示例角色.装备.武器.属性加成","char.示例角色.装备.武器.属性加成.防御","char.示例角色.装备.武器.属性加成.魂力上限","char.示例角色.装备.武器.属性加成.精神力上限","char.示例角色.装备.武器.属性加成.力量","char.示例角色.装备.武器.属性加成.敏捷","char.示例角色.装备.武器.属性加成.体力上限","char.示例角色.状态.横坐标","char.示例角色.状态.吸收灵物年限","char.示例角色.状态.纵坐标","char.示例角色.状态.HP","char.示例角色.自创魂技","char.示例角色.自创魂技.示例项","char.示例角色.自创魂技.示例项._效果数组","char.示例角色.自创魂技.示例项._效果数组.[]","char.示例角色.自创魂技.示例项.附带属性","char.示例角色.自创魂技.示例项.附带属性.[]","char.示例角色.自创魂技.示例项.机制决策临时","char.示例角色.自创魂技.示例项.技能掌控度","char.示例角色.自创魂技.示例项.技能掌控度.圆满等级","char.示例角色.自创魂技.示例项.技能掌控度.中心等级","char.示例角色.自创魂技.示例项.前摇","char.示例角色.自创魂技.示例项.消耗","sys","sys.玩家名","sys.最终成功率","world.传灵塔千年魂灵开放","world.地点.示例地点.经济状况","world.地点.示例地点.子节点.示例项","world.地点.示例地点.x","world.地点.示例地点.y","world.动态地点.示例动态地点.层级","world.动态地点.示例动态地点.重要度","world.动态地点.示例动态地点.x","world.动态地点.示例动态地点.y","world.交易请求","world.交易请求.动作","world.交易请求.对象","world.交易请求.货币","world.交易请求.价格","world.交易请求.来源","world.交易请求.目标","world.交易请求.数量","world.交易请求.物品","world.交易请求.状态","world.交易请求.自动执行","world.累计击杀年限","world.偏差倍率","world.偏差值","world.时间._上次结算tick","world.时间._calendar","world.时间.tick","world.图鉴","world.图鉴.示例图鉴","world.图鉴.示例图鉴.成长倾向","world.图鉴.示例图鉴.当前档经验","world.图鉴.示例图鉴.击杀次数","world.图鉴.示例图鉴.交手次数","world.图鉴.示例图鉴.情报协同系数","world.图鉴.示例图鉴.任务协同系数","world.图鉴.示例图鉴.探索收益","world.图鉴.示例图鉴.图鉴档位","world.图鉴.示例图鉴.下档需求","world.图鉴.示例图鉴.战斗标签样本","world.图鉴.示例图鉴.战斗标签样本.示例项","world.图鉴.示例图鉴.战斗收益","world.图鉴.示例图鉴.战斗样本数","world.图鉴.示例图鉴.最近活跃tick","world.图鉴.示例图鉴.最近升档tick","world.图鉴.示例图鉴.最近战斗标签","world.委托板","world.委托板.示例委托","world.委托板.示例委托.承接者","world.委托板.示例委托.发布者","world.委托板.示例委托.奖励币","world.委托板.示例委托.奖励声望","world.委托板.示例委托.类型","world.委托板.示例委托.面向","world.委托板.示例委托.目标进度","world.委托板.示例委托.难度","world.委托板.示例委托.生成tick","world.委托板.示例委托.指定对象","world.委托板.示例委托.状态","world.委托板.示例委托.资源级别","world.战斗","world.战斗.裁断结果","world.战斗.参战者","world.战斗.参战者.示例项","world.战斗.环境","world.战斗.回合","world.战斗.进行中","world.战斗.先攻","world.战斗.允许撤离","world.战斗.战斗类型","world.战斗.战斗意图"];
const MVU更新视图排除路径模板_V1 = ["当前","当前.地点","当前.时间","当前.时间._上次结算tick","当前.时间._calendar","当前.时间.tick","当前.玩家","当前.玩家行动","当前.系统播报","剧情钩子","剧情钩子._引导","剧情钩子._引导.时间线预览","剧情钩子.机密情报","剧情钩子.机密情报.示例情报","剧情钩子.机密情报.示例情报.标题","剧情钩子.机密情报.示例情报.内容","剧情钩子.交易请求","剧情钩子.拍卖","剧情钩子.拍卖.地点","剧情钩子.委托板","剧情钩子.委托板.示例委托","剧情钩子.委托板.示例委托.标题","剧情钩子.委托板.示例委托.类型","剧情钩子.委托板.示例委托.描述","剧情钩子.战斗","物品.示例物品.属性加成.示例项","物品.示例物品.装备技能.示例项","物品.示例物品.装备技能.示例项._效果数组","物品.示例物品.装备技能.示例项._效果数组.[]","物品.示例物品.装备技能.示例项.附带属性","物品.示例物品.装备技能.示例项.附带属性.[]","物品.示例物品.装备技能.示例项.画面描述","物品.示例物品.装备技能.示例项.魂技名","物品.示例物品.装备技能.示例项.机制决策临时","物品.示例物品.装备技能.示例项.技能掌控度","物品.示例物品.装备技能.示例项.技能掌控度.圆满等级","物品.示例物品.装备技能.示例项.技能掌控度.中心等级","物品.示例物品.装备技能.示例项.前摇","物品.示例物品.装备技能.示例项.消耗","物品.示例物品.装备技能.示例项.效果描述","相关实体索引","相关实体索引.角色","相关实体索引.角色.[]","相关实体索引.命物品","相关实体索引.命物品.[]","相关实体索引.命中地点","相关实体索引.命中地点.[]","相关实体索引.命中动态地点","相关实体索引.命中动态地点.[]","相关实体索引.命中势力","相关实体索引.命中势力.[]","char.示例角色.__mvu_isPlayer","char.示例角色.第一武魂.已解锁属性","char.示例角色.第一武魂.已解锁属性.[]","char.示例角色.魂骨.示例项.附带技能.示例项","char.示例角色.魂骨.示例项.附带技能.示例项._效果数组","char.示例角色.魂骨.示例项.附带技能.示例项._效果数组.[]","char.示例角色.魂骨.示例项.附带技能.示例项.附带属性","char.示例角色.魂骨.示例项.附带技能.示例项.附带属性.[]","char.示例角色.魂骨.示例项.附带技能.示例项.机制决策临时","char.示例角色.魂骨.示例项.附带技能.示例项.技能掌控度","char.示例角色.魂骨.示例项.附带技能.示例项.技能掌控度.圆满等级","char.示例角色.魂骨.示例项.附带技能.示例项.技能掌控度.中心等级","char.示例角色.魂骨.示例项.附带技能.示例项.前摇","char.示例角色.魂骨.示例项.附带技能.示例项.消耗","char.示例角色.魂骨.示例项.属性加成","char.示例角色.魂骨.示例项.属性加成.防御","char.示例角色.魂骨.示例项.属性加成.魂力上限","char.示例角色.魂骨.示例项.属性加成.精神力上限","char.示例角色.魂骨.示例项.属性加成.力量","char.示例角色.魂骨.示例项.属性加成.敏捷","char.示例角色.魂骨.示例项.属性加成.体力上限","char.示例角色.魂骨.示例项.状态","char.示例角色.记录","char.示例角色.记录.示例项","char.示例角色.记录.示例项.当前进度","char.示例角色.记录.示例项.分支","char.示例角色.记录.示例项.风险级别","char.示例角色.记录.示例项.奖励币","char.示例角色.记录.示例项.奖励声望","char.示例角色.记录.示例项.阶段","char.示例角色.记录.示例项.类型","char.示例角色.记录.示例项.目标进度","char.示例角色.记录.示例项.情报贡献值","char.示例角色.记录.示例项.失败计数","char.示例角色.记录.示例项.图鉴贡献值","char.示例角色.记录.示例项.推荐路线","char.示例角色.记录.示例项.状态","char.示例角色.记录.示例项.最后更新时间tick","char.示例角色.记录.示例项.最近爆发tick","char.示例角色.晋升请求","char.示例角色.晋升请求.目标势力","char.示例角色.晋升请求.目标职位","char.示例角色.捐献请求","char.示例角色.捐献请求.目标势力","char.示例角色.捐献请求.数量","char.示例角色.捐献请求.物品名称","char.示例角色.任务请求","char.示例角色.任务请求.动作","char.示例角色.任务请求.奖励币","char.示例角色.任务请求.奖励声望","char.示例角色.任务请求.进度增量","char.示例角色.任务请求.目标进度","char.示例角色.任务请求.任务描述","char.示例角色.任务请求.任务名称","char.示例角色.社交.称号","char.示例角色.社交.称号.示例项","char.示例角色.社交.称号.示例项.来源","char.示例角色.社交.称号.示例项.声望加成","char.示例角色.社交.公开情报","char.示例角色.社交.关系.示例角色._当前关系加成","char.示例角色.社交.关系.示例角色._关系阶段","char.示例角色.社交.关系.示例角色._可切线","char.示例角色.社交.关系.示例角色._切线限制原因","char.示例角色.社交.关系.示例角色._推进提示","char.示例角色.社交.关系.示例角色._维护优先级","char.示例角色.社交.关系.示例角色._下档解锁加成","char.示例角色.社交.关系.示例角色._下档解锁阈值","char.示例角色.社交.关系.示例角色._下一阶段","char.示例角色.社交.关系.示例角色._下一阶段阈值","char.示例角色.社交.关系.示例角色.好感加成","char.示例角色.社交.关系.示例角色.上次互动tick","char.示例角色.社交.关系分析","char.示例角色.社交.关系分析.风险对象","char.示例角色.社交.关系分析.风险对象.[]","char.示例角色.社交.关系分析.关注对象","char.示例角色.社交.关系分析.可联络对象","char.示例角色.社交.关系分析.可联络对象.[]","char.示例角色.社交.关系分析.恋爱候选","char.示例角色.社交.关系分析.恋爱候选.[]","char.示例角色.社交.关系分析.受阻对象","char.示例角色.社交.关系分析.受阻对象.[]","char.示例角色.社交.关系分析.受阻对象.[].对象","char.示例角色.社交.关系分析.受阻对象.[].原因","char.示例角色.社交.关系分析.同地对象","char.示例角色.社交.关系分析.同地对象.[]","char.示例角色.社交.关系分析.信任对象","char.示例角色.社交.关系分析.信任对象.[]","char.示例角色.社交.关系分析.摘要","char.示例角色.社交.关系分析.重点对象","char.示例角色.社交.名望等级","char.示例角色.属性.背景","char.示例角色.属性.背景阶层","char.示例角色.属性.等级惩罚","char.示例角色.属性.底子波动","char.示例角色.属性.防御","char.示例角色.属性.魂力上限","char.示例角色.属性.基础魂力上限","char.示例角色.属性.精神境界","char.示例角色.属性.精神力上限","char.示例角色.属性.力量","char.示例角色.属性.敏捷","char.示例角色.属性.上次灵物等级","char.示例角色.属性.体力上限","char.示例角色.属性.天赋评级","char.示例角色.属性.天赋梯队","char.示例角色.属性.突破魂力上限","char.示例角色.属性.训练加成","char.示例角色.属性.训练加成.防御","char.示例角色.属性.训练加成.精神力上限","char.示例角色.属性.训练加成.力量","char.示例角色.属性.训练加成.敏捷","char.示例角色.属性.训练加成.体力上限","char.示例角色.属性.永久魂力加成","char.示例角色.属性.状态效果","char.示例角色.属性.状态效果.示例项","char.示例角色.属性.状态效果.示例项.层数","char.示例角色.属性.状态效果.示例项.持续回合","char.示例角色.属性.状态效果.示例项.类型","char.示例角色.属性.状态效果.示例项.面板倍率","char.示例角色.属性.状态效果.示例项.面板倍率.防御","char.示例角色.属性.状态效果.示例项.面板倍率.魂力上限","char.示例角色.属性.状态效果.示例项.面板倍率.力量","char.示例角色.属性.状态效果.示例项.面板倍率.敏捷","char.示例角色.属性.状态效果.示例项.描述","char.示例角色.属性.状态效果.示例项.战斗效果","char.示例角色.属性.状态效果.示例项.战斗效果.持续伤害","char.示例角色.属性.状态效果.示例项.战斗效果.破防比例","char.示例角色.属性.状态效果.示例项.战斗效果.跳过回合","char.示例角色.属性.HP上限","char.示例角色.武魂融合技.示例项","char.示例角色.武魂融合技.示例项.技能数据","char.示例角色.武魂融合技.示例项.技能数据._效果数组","char.示例角色.武魂融合技.示例项.技能数据._效果数组.[]","char.示例角色.武魂融合技.示例项.技能数据.附带属性","char.示例角色.武魂融合技.示例项.技能数据.附带属性.[]","char.示例角色.武魂融合技.示例项.技能数据.机制决策临时","char.示例角色.武魂融合技.示例项.技能数据.技能掌控度","char.示例角色.武魂融合技.示例项.技能数据.技能掌控度.圆满等级","char.示例角色.武魂融合技.示例项.技能数据.技能掌控度.中心等级","char.示例角色.武魂融合技.示例项.技能数据.前摇","char.示例角色.武魂融合技.示例项.技能数据.消耗","char.示例角色.血脉之力","char.示例角色.血脉之力.被动","char.示例角色.血脉之力.被动.示例项","char.示例角色.血脉之力.被动.示例项._效果数组","char.示例角色.血脉之力.被动.示例项._效果数组.[]","char.示例角色.血脉之力.被动.示例项.附带属性","char.示例角色.血脉之力.被动.示例项.附带属性.[]","char.示例角色.血脉之力.被动.示例项.机制决策临时","char.示例角色.血脉之力.被动.示例项.技能掌控度","char.示例角色.血脉之力.被动.示例项.技能掌控度.圆满等级","char.示例角色.血脉之力.被动.示例项.技能掌控度.中心等级","char.示例角色.血脉之力.被动.示例项.前摇","char.示例角色.血脉之力.被动.示例项.消耗","char.示例角色.血脉之力.技能.示例项","char.示例角色.血脉之力.技能.示例项._效果数组","char.示例角色.血脉之力.技能.示例项._效果数组.[]","char.示例角色.血脉之力.技能.示例项.附带属性","char.示例角色.血脉之力.技能.示例项.附带属性.[]","char.示例角色.血脉之力.技能.示例项.机制决策临时","char.示例角色.血脉之力.技能.示例项.技能掌控度","char.示例角色.血脉之力.技能.示例项.技能掌控度.圆满等级","char.示例角色.血脉之力.技能.示例项.技能掌控度.中心等级","char.示例角色.血脉之力.技能.示例项.前摇","char.示例角色.血脉之力.技能.示例项.消耗","char.示例角色.血脉之力.永久加成","char.示例角色.血脉之力.永久加成.示例项","char.示例角色.血脉之力.永久加成.示例项.来源层级","char.示例角色.血脉之力.永久加成.示例项.属性加成","char.示例角色.血脉之力.永久加成.示例项.属性加成.防御","char.示例角色.血脉之力.永久加成.示例项.属性加成.魂力上限","char.示例角色.血脉之力.永久加成.示例项.属性加成.精神力上限","char.示例角色.血脉之力.永久加成.示例项.属性加成.力量","char.示例角色.血脉之力.永久加成.示例项.属性加成.敏捷","char.示例角色.血脉之力.永久加成.示例项.属性加成.体力上限","char.示例角色.血脉之力.永久加成.示例项.效果描述","char.示例角色.血脉之力.永久加成.示例项.状态","char.示例角色.职业","char.示例角色.职业.示例项","char.示例角色.职业.示例项.称号","char.示例角色.职业.示例项.等级","char.示例角色.职业.示例项.核心技艺","char.示例角色.职业.示例项.核心技艺.示例项","char.示例角色.职业.示例项.经验","char.示例角色.职业.示例项.限制","char.示例角色.职业.示例项.限制.成功率","char.示例角色.职业.示例项.限制.最大融合数","char.示例角色.装备.斗铠._属性加成","char.示例角色.装备.斗铠._属性加成.等效等级","char.示例角色.装备.斗铠._属性加成.防御","char.示例角色.装备.斗铠._属性加成.魂力上限","char.示例角色.装备.斗铠._属性加成.精神力上限","char.示例角色.装备.斗铠._属性加成.力量","char.示例角色.装备.斗铠._属性加成.敏捷","char.示例角色.装备.斗铠._属性加成.体力上限","char.示例角色.装备.斗铠._已排异","char.示例角色.装备.斗铠.部件","char.示例角色.装备.斗铠.部件.示例项","char.示例角色.装备.斗铠.部件.示例项.品质系数","char.示例角色.装备.斗铠.部件.示例项.状态","char.示例角色.装备.机甲._属性加成","char.示例角色.装备.机甲._属性加成.防御","char.示例角色.装备.机甲._属性加成.魂力上限","char.示例角色.装备.机甲._属性加成.精神力上限","char.示例角色.装备.机甲._属性加成.力量","char.示例角色.装备.机甲._属性加成.敏捷","char.示例角色.装备.机甲._属性加成.体力上限","char.示例角色.装备.机甲.品质系数","char.示例角色.装备.武器.属性加成","char.示例角色.装备.武器.属性加成.防御","char.示例角色.装备.武器.属性加成.魂力上限","char.示例角色.装备.武器.属性加成.精神力上限","char.示例角色.装备.武器.属性加成.力量","char.示例角色.装备.武器.属性加成.敏捷","char.示例角色.装备.武器.属性加成.体力上限","char.示例角色.状态.横坐标","char.示例角色.状态.吸收灵物年限","char.示例角色.状态.纵坐标","char.示例角色.自创魂技","char.示例角色.自创魂技.示例项","char.示例角色.自创魂技.示例项._效果数组","char.示例角色.自创魂技.示例项._效果数组.[]","char.示例角色.自创魂技.示例项.附带属性","char.示例角色.自创魂技.示例项.附带属性.[]","char.示例角色.自创魂技.示例项.机制决策临时","char.示例角色.自创魂技.示例项.技能掌控度","char.示例角色.自创魂技.示例项.技能掌控度.圆满等级","char.示例角色.自创魂技.示例项.技能掌控度.中心等级","char.示例角色.自创魂技.示例项.前摇","char.示例角色.自创魂技.示例项.消耗","sys","sys.玩家名","sys.最终成功率","world.传灵塔千年魂灵开放","world.地点.示例地点.商店.示例商店","world.地点.示例地点.商店.示例商店._下次刷新tick","world.地点.示例地点.商店.示例商店.库存","world.地点.示例地点.商店.示例商店.库存.示例物品","world.地点.示例地点.商店.示例商店.库存.示例物品.价格倍率","world.地点.示例地点.商店.示例商店.库存.示例物品.库存","world.地点.示例地点.商店.示例商店.库存.示例物品.需求","world.地点.示例地点.商店.示例商店.库存.示例物品.需求.示例项","world.地点.示例地点.商店.示例商店.库存.示例物品.需求声望","world.地点.示例地点.商店.示例商店.库存.示例物品.折扣","world.地点.示例地点.子节点.示例项","world.地点.示例地点.x","world.地点.示例地点.y","world.动态地点.示例动态地点.重要度","world.机密情报.示例情报.触发来源","world.机密情报.示例情报.反证权重","world.机密情报.示例情报.核实进度","world.机密情报.示例情报.核实阈值","world.机密情报.示例情报.核实状态","world.机密情报.示例情报.证据来源列表","world.机密情报.示例情报.证据来源列表.[]","world.机密情报.示例情报.证据权重","world.机密情报.示例情报.知情对象","world.机密情报.示例情报.知情对象.[]","world.机密情报.示例情报.最后证据tick","world.机密情报.示例情报.最近核实结果","world.机密情报.示例情报.最近核实tick","world.交易请求","world.交易请求.动作","world.交易请求.对象","world.交易请求.货币","world.交易请求.价格","world.交易请求.来源","world.交易请求.目标","world.交易请求.数量","world.交易请求.物品","world.交易请求.状态","world.交易请求.自动执行","world.累计击杀年限","world.拍卖.拍品","world.拍卖.拍品.示例项","world.拍卖.拍品.示例项.背景","world.拍卖.拍品.示例项.价格","world.拍卖.拍品.示例项.品级","world.拍卖.下次刷新tick","world.拍卖.状态","world.偏差倍率","world.偏差值","world.时间._上次结算tick","world.时间._calendar","world.图鉴.示例图鉴.成长倾向","world.图鉴.示例图鉴.当前档经验","world.图鉴.示例图鉴.击杀次数","world.图鉴.示例图鉴.交手次数","world.图鉴.示例图鉴.情报协同系数","world.图鉴.示例图鉴.任务协同系数","world.图鉴.示例图鉴.探索收益","world.图鉴.示例图鉴.下档需求","world.图鉴.示例图鉴.战斗标签样本","world.图鉴.示例图鉴.战斗标签样本.示例项","world.图鉴.示例图鉴.战斗收益","world.图鉴.示例图鉴.战斗样本数","world.图鉴.示例图鉴.最近活跃tick","world.图鉴.示例图鉴.最近升档tick","world.图鉴.示例图鉴.最近战斗标签","world.委托板.示例委托.承接者","world.委托板.示例委托.发布者","world.委托板.示例委托.奖励币","world.委托板.示例委托.奖励声望","world.委托板.示例委托.框架描述","world.委托板.示例委托.面向","world.委托板.示例委托.目标进度","world.委托板.示例委托.难度","world.委托板.示例委托.生成tick","world.委托板.示例委托.指定对象","world.委托板.示例委托.状态","world.委托板.示例委托.资源级别","world.战斗","world.战斗.裁断结果","world.战斗.参战者","world.战斗.参战者.示例项","world.战斗.环境","world.战斗.回合","world.战斗.进行中","world.战斗.先攻","world.战斗.允许撤离","world.战斗.战斗类型","world.战斗.战斗意图"];
const MVU视图动态段模板_V1 = new Set(['示例角色', '示例物品', '示例地点', '示例动态地点', '示例势力', '示例情报', '示例委托', '示例图鉴', '示例商店', '示例项', '示例人物', '示例身份']);
...
function 编译MVU视图路径模板_V1(路径列表 = []) {
  return 路径列表
    .map(路径 => String(路径 || '').split('.').filter(Boolean).map(标准化MVU视图路径模板段_V1))
    .filter(路径 => 路径.length > 0);
}

const MVU正文视图排除路径_V1 = 编译MVU视图路径模板_V1(MVU正文视图排除路径模板_V1);
const MVU更新视图排除路径_V1 = 编译MVU视图路径模板_V1(MVU更新视图排除路径模板_V1);

function MVU视图路径匹配_V1(实际路径 = [], 模板路径 = []) {
  if (!Array.isArray(实际路径) || !Array.isArray(模板路径) || 实际路径.length !== 模板路径.length) return false;
  return 模板路径.every((模板段, index) => 模板段 === '*' || 模板段 === String(实际路径[index] || ''));
}

function MVU视图路径排除状态_V1(实际路径 = [], 排除路径列表 = []) {
  return {
    精确排除: 排除路径列表.some(模板路径 => MVU视图路径匹配_V1(实际路径, 模板路径)),
  };
}
...
function 准备运行时地图视图数据_V1(值, 当前键 = '') {
  if (值 === undefined || 值 === null) return undefined;
  const 字段 = String(当前键 || '').trim();
  if (['x', 'y'].includes(字段)) return undefined;
  if (字段 === '状态') return 中文化地图状态_V1(值);
  if (Array.isArray(值)) {
    return 值
      .map(项 => 准备运行时地图视图数据_V1(项, 当前键))
      .filter(项 => 项 !== undefined);
  }
  if (typeof 值 === 'object') {
    const 对象 = {};
    Object.entries(值).forEach(([键, 子值]) => {
      const 处理后 = 准备运行时地图视图数据_V1(子值, 键);
...
function 收集运行时相关物品名_V1(数据根 = {}, 文本 = '', 角色名集合 = new Set()) {
  ...
  角色名集合.forEach(角色名 => {
    ...
    Object.keys(角色?.背包 || {}).forEach(物品名 => {
      if (运行时文本命中商品名_V1(文本, 物品名)) 物品名集合.add(物品名);
    });
    ['互动请求'].forEach(键 => {
      const 请求 = 角色?.[键];
...
function 取运行时在场角色名集合_V1(数据根 = {}) {
  const { 当前地点 } = 取运行时当前范围_V1(数据根);
  const 在场角色名集合 = new Set();
  Object.entries(数据根?.char || {}).forEach(([角色名, 角色数据]) => {
    const 角色地点 = 角色数据?.状态?.位置 || '未知';
    if (角色地点 !== '未知' && 运行时地点兼容_V1(当前地点, 角色地点)) 在场角色名集合.add(角色名);
  });
  return 在场角色名集合;
}
...
function 构建正文商店库存摘要_V1(地点数据 = {}, 数据根 = {}, 文本 = '') {
  ...
  Object.entries(地点数据.商店 || {}).forEach(([商店名, 商店数据]) => {
    ...
    Object.entries(商店数据?.库存 || {}).forEach(([商品名, 交易数据]) => {
      if (!命中商店 && !运行时文本命中商品名_V1(文本, 商品名)) return;
...
function 构建更新地点薄片_V1(地点数据 = {}, 文本 = '') {
  return 过滤MVU更新视图值_V1(准备运行时地图视图数据_V1(cloneJsonValue(地点数据, {})), ['world', '地点', '示例地点']) || {};
}
...
function 生成MVU正文视图_V1(数据输入 = null, userInput = '', plotText = '') {
  ...
  地点名集合.forEach(地点名 => {
    ...
    const 清理后 = 过滤MVU正文视图值_V1(准备运行时地图视图数据_V1(地点基础), ['world', '地点', '示例地点']);
  ...
  动态地点名集合.forEach(地点名 => {
    ...
    const 清理后 = 过滤MVU正文视图值_V1(准备运行时地图视图数据_V1(cloneJsonValue(地点, {})), ['world', '动态地点', '示例动态地点']);
    if (清理后) {
  ...
  物品名集合.forEach(物品名 => {
    ...
    if (摘要 && Object.keys(摘要).length) 视图.物品[物品名] = 摘要;
  });
...
function 生成MVU更新视图_V1(数据输入 = null, userInput = '', aiText = '', plotText = '') {
  ...
  动态地点名集合.forEach(地点名 => {
    if (数据根?.world?.动态地点?.[地点名]) 视图.world.动态地点[地点名] = 过滤MVU更新视图值_V1(准备运行时地图视图数据_V1(cloneJsonValue(数据根.world.动态地点[地点名], {})), ['world', '动态地点', '示例动态地点']);
  });
...
function 生成MVU剧情视图_V1(数据输入 = null, userInput = '') {
  ...
  return {
    ...
    相关实体索引: {
      角色: Array.from(角色名集合),
      在场人物: Array.from(取运行时在场角色名集合_V1(数据根)),
...
function 替换MVU运行时视图占位符_V1(文本 = '', 视图类型 = 'empty', 上下文 = {}) {
  ...
  const 更新视图 = 生成MVU更新视图_V1(数据根, userInput, aiText, plotText);
...
const SKILL_MECHANISM_META_V1 = (() => {
  ...
  register('召唤', {
    ...
    设计台参数定义: [
      ...
      text('召唤物种', '召唤物种', '龙类 / 魂师 / 深渊魔傀'),
      text('summonName', '召唤物名称', '本命召唤兽'),
      num('summonCount', '召唤数量', '1', '1'),
      num('召唤强度', '召唤强度', '1.0'),
      num('inheritRatio', '构造继承', '0.35'),
      num('duration', '持续回合', '3', '1'),
...
const SKILL_RUNTIME_CONSUMER_TO_PROTOTYPES_V1 = Object.freeze({
  ...
  counter: [原型编译条目('状态施加', { 状态: '反制' })],
  on_hit_counter: [原型编译条目('状态施加', { 状态: '受击反击' })],
...
const SKILL_PROTOTYPE_FIELD_OPTIONS_V1 = Object.freeze({
  ...
  抹消目标: Object.freeze(['复苏', '护盾', '隐身', '增益', '防御机制', '回复机制', '控制机制', '特殊规则']),
  窃取目标: Object.freeze(['复苏', '护盾', '隐身', '增益', '防御机制', '回复机制']),
  ...
  触发限制周期: Object.freeze(['每日', '每战', '每回合', '每次施放']),
  ...
  召唤单位类型: Object.freeze(['人类', '魂师', '魂兽', '灵体', '造物', '分身', '投影', '傀儡', '深渊生物']),
  承伤规则: Object.freeze(['不替主承伤', '可承伤', '护卫承伤', '分摊承伤']),
  召唤模板来源: Object.freeze(['技能固定模板', '已存在召唤物', '目标复刻', '自身投影', '剧情指定']),
...
const 技能机制抹消目标别名_V1 = Object.freeze({
  隐匿: '隐身',
  潜行: '隐身',
  防御: '防御机制',
  护盾机制: '护盾',
...
function 召唤单位允许继承属性_V1(召唤单位类型 = '') {
  return ['灵体', '造物', '分身', '投影', '傀儡'].includes(String(召唤单位类型 || '').trim());
}

function 规范化技能机制抹消目标_V1(值 = '', 模式 = '抹消') {
  const 候选 = 模式 === '窃取' ? SKILL_PROTOTYPE_FIELD_OPTIONS_V1.窃取目标 : SKILL_PROTOTYPE_FIELD_OPTIONS_V1.抹消目标;
  const 候选集合 = new Set(候选);
  const 列表 = (Array.isArray(值) ? 值 : [值])
    .flatMap(条目 => String(条目 || '').split(/[、,，/|｜；;\s]+/g))
    .map(条目 => String(条目 || '').trim())
    .map(条目 => 技能机制抹消目标别名_V1[条目] || 条目)
...
const SKILL_PROTOTYPE_DEFINITION_LIST_V1 = Object.freeze([
  ...
  ['资源变化', '战斗结算', '上下文', ['资源', '数值', '触发', '持续回合', '持续tick', '资源转移角色', '转化比例', '驱动属性', '影响方向'], ['资源', '数值'], '恢复或扣除生命、体力、魂力、精神力等资源'],
  ...
  ['状态施加', '战斗结算', '上下文', ['状态', '层级', '数值', '持续回合', '触发限制', '状态效果', '驱动属性', '影响方向'], ['状态'], '施加中毒、冻伤、沉默、缴械、隐匿、霸体、无敌等概括状态'],
  ...
  ['召唤生成', '战斗结算', '召唤物', ['召唤单位类型', '召唤物种', '召唤物名称', '数量', '行动模式', '继承属性比例', '强度', '持续回合', '承伤规则', '召唤模板来源'], ['召唤单位类型', '召唤物名称', '数量'], '生成战斗或非战斗召唤单位'],
...
const 技能条件分支对象候选_V1 = Object.freeze(['目标', '自身']);
  ...
  return [
    {
      ...
      生效方式,
      资源转移角色: 转移类型 === '吞噬' ? '来源扣减' : '共享来源',
      转化比例: Number(Math.max(0, Number(转化比例 || 1)).toFixed(4)),
      ...共享字段,
    },
    {
      原型: '资源变化',
...
function 构建缺少来源状态禁用条件分支_V1(状态 = '任意状态', 来源 = '自身') {
  return [{
    条件: [{
      类型: '状态',
      对象: /目标/.test(String(来源 || '')) ? '目标' : '自身',
      比较: '无',
      状态: String(状态 || '任意状态').trim() || '任意状态',
    }],
    处理: '禁用基础效果',
  }];
}
...
function 补足机制模板原型数值_V1(原型 = '', 字段 = {}, source = {}) {
  ...
  if (原型 === '判定修正') {
    ...
    字段.抹消目标 = 规范化技能机制抹消目标_V1(字段.抹消目标 ?? source.抹消目标 ?? source.suppressTarget ?? '', '抹消');
    if (字段.数量 === undefined) 字段.数量 = Math.max(1, Math.round(Number(source.数量 || source.抹消数量 || 1)));
    return;
  } else if (原型 === '机制窃取') {
    字段.窃取目标 = 规范化技能机制抹消目标_V1(字段.窃取目标 ?? source.窃取目标 ?? source.抹消目标 ?? source.stealTarget ?? '', '窃取');
    ...
    if (字段.条件分支 === undefined) 字段.条件分支 = 构建缺少来源状态禁用条件分支_V1(字段.状态, 字段.来源);
    return;
  } else if (原型 === '伤害链') {
    if (字段.数值 === undefined) {
    ...
    if (字段.召唤物种 === undefined) 字段.召唤物种 = String(source.召唤物种 || source.物种 || (字段.召唤单位类型 === '魂兽' ? '未指定魂兽' : '未指定')).trim() || '未指定';
    ...
    if (字段.强度 === undefined) 字段.强度 = Math.max(0.01, Number(source.强度 || source.召唤强度 || 1));
    if (字段.承伤规则 === undefined) 字段.承伤规则 = String(source.承伤规则 || '不替主承伤').trim() || '不替主承伤';
    if (字段.召唤模板来源 === undefined) 字段.召唤模板来源 = String(source.召唤模板来源 || '技能固定模板').trim() || '技能固定模板';
    if (!召唤单位允许继承属性_V1(字段.召唤单位类型)) delete 字段.继承属性比例;
    return;
  } else if (原型 === '场地施加') {
...
const 纯布尔控制状态集合_V1 = new Set(['眩晕', '沉默', '缴械', '致盲', '封技', '位移限制', '霸体', '无敌']);

function 清理执行效果原型语义_V1(原型 = '', 字段 = {}) {
  if (!字段 || typeof 字段 !== 'object') return;
  ...
  if (原型 === '召唤生成') {
    ...
    字段.召唤物种 = String(字段.召唤物种 || (字段.召唤单位类型 === '魂兽' ? '未指定魂兽' : '未指定')).trim() || '未指定';
    字段.数量 = Math.max(1, Math.round(Number(字段.数量 || 1)));
    字段.强度 = Math.max(0.01, Number(字段.强度 || 1));
    if (!召唤单位允许继承属性_V1(字段.召唤单位类型)) delete 字段.继承属性比例;
    else 字段.继承属性比例 = Math.max(0, Math.min(1, Number(字段.继承属性比例 || 0)));
    return;
  }
  if (原型 !== '状态施加') return;
  const 状态名 = String(字段.状态 || '').trim();
  if (!纯布尔控制状态集合_V1.has(状态名)) return;
  delete 字段.数值;
  delete 字段.驱动属性;
  delete 字段.影响方向;
  delete 字段.概率;
...
function 收口原型效果条目_V1(value = {}, fallbackTargetModel = '单体', recordViolation = () => {}, forcedPrototype = '', 上下文 = {}) {
  ...
  if (原型 === '召唤生成') 清理执行效果原型语义_V1(原型, 原型字段);
...
function buildSkillCombatProfile(blueprint, qualityCtx = {}) {
  ...
  if (main === '伤害类') {
    ...
    if (archetype === '召唤') {
      ...
      state.计算层效果.final_damage_mult = Number(Math.min(1.45, 1 + 召唤强度 * 0.12 + 召唤数量 * 0.03).toFixed(2));
      if (state.召唤元数据.承伤规则 === '可承伤') state.计算层效果.damage_reduction = Number(Math.min(0.28, 召唤强度 * 0.08).toFixed(2));
    }
    if (archetype === '召唤与场地') {
      战斗.技能类型 = '辅助';
      战斗.对象 = '自身';
  ...
  if (secondary.includes('无敌金身')) {
    ...
    state.特殊机制标识 = [state.特殊机制标识, `无敌金身:${goldenDuration}回合/神级以下免疫`]
      .filter(v => v && v !== '无')
      .join('/');
    state.计算层效果.invincible = true;
    state.计算层效果.super_armor = true;
...
function buildCreationUsageEffects(packedEffects, type = '') {
  ...
  return clonePackedSkillEffects(getMeaningfulSkillEffects(packedEffects))
    .map(effect => {
      ...
      const cloned = { ...effect };
      if (isFood) {
        if (String(cloned.原型 || '').trim() === '机制授予') cloned.目标 = '食用者';
        else if (!String(cloned.目标 || '').trim() || String(cloned.目标 || '').trim() === '自身') cloned.目标 = '食用者';
      }
      return cloned;
    });
}
...
const 技能状态施加转译语义_V1 = Object.freeze({
  标记: 目标 => `为${目标}附加后续锁定、追踪或条件判定用的标记`,
  中毒: 目标 => `使${目标}进入中毒状态`,
  流血: 目标 => `使${目标}进入流血状态`,
  灼烧: 目标 => `使${目标}进入灼烧状态`,
  冻伤: 目标 => `使${目标}进入冻伤状态`,
  持续创伤: 目标 => `使${目标}承受持续创伤`,
  持续恢复: 目标 => `使${目标}获得持续恢复状态`,
  迟缓: 目标 => `使${目标}进入迟缓状态`,
  资源燃烧: 目标 => `使${目标}进入资源燃烧状态`,
  眩晕: 目标 => `使${目标}进入眩晕状态`,
  沉默: 目标 => `使${目标}进入沉默状态`,
  缴械: 目标 => `使${目标}进入缴械状态`,
  致盲: 目标 => `使${目标}进入致盲状态`,
  禁疗: 目标 => `使${目标}进入禁疗状态`,
  治疗反转: 目标 => `使${目标}进入治疗反转状态`,
  隐匿: 目标 => `使${目标}进入隐匿状态`,
  护盾: 目标 => `使${目标}获得护盾状态`,
  无敌: 目标 => `使${目标}进入无敌状态`,
  霸体: 目标 => `使${目标}进入霸体状态`,
...
function 转译技能状态施加描述_V1(效果 = {}, 目标 = '目标') {
  const 状态 = 格式化技能结构转译字段_V1(效果?.状态 || 效果?.状态名称, '状态');
  const 转译 = 技能状态施加转译语义_V1[状态];
  if (typeof 转译 === 'function') return 转译(目标, 效果);
  return `使${目标}进入【${状态}】状态`;
}
...
function 转译单条执行效果_V1(效果 = {}, 选项 = {}) {
  ...
  switch (原型) {
    ...
    case '状态施加':
      return `${转译技能状态施加描述_V1(效果, 目标)}${附加}${嵌套('状态效果', '状态内效果')}`;
    case '状态时窗修正':
    ...
    case '机制授予':
      return `使${目标}获得后续触发权${效果.可用次数 ? `，可用${formatSkillNumber(效果.可用次数)}次` : ''}${附加}${嵌套('授予效果', '后续可触发效果')}`;
    case '复制执行':
    ...
    case '召唤生成': {
      ...
      const 召唤物种 = 格式化技能结构转译字段_V1(效果.召唤物种, '');
      const 名称 = 格式化技能结构转译字段_V1(效果.召唤物名称, '召唤物');
      const 允许继承属性 = 召唤单位允许继承属性_V1(召唤单位类型);
      const 强度文本 = !允许继承属性 && 效果.强度 ? `，模板强度约${formatSkillNumber(效果.强度)}` : '';
      const 继承文本 = 允许继承属性 && 效果.继承属性比例 ? `，继承施术者约${转译技能比例描述_V1(效果.继承属性比例)}属性` : '';
      return `召唤${召唤单位类型}${召唤物种 && 召唤物种 !== '未指定' ? `/${召唤物种}` : ''}【${名称}】×${formatSkillNumber(效果.数量 || 1)}${效果.行动模式 ? `，${效果.行动模式}` : ''}${强度文本}${继承文本}${附加}`;
    }
    case '场地施加':
    ...
    default: {
      ...
      const 字段文本 = Object.entries(效果)
        .filter(([键]) => !['原型', '目标', '生效方式', '条件分支', '触发限制', '消耗', '副作用列表', '使用效果', '授予效果', '状态效果', '结算效果', '场地效果'].includes(键))
        .map(([键, 原始值]) => `${键}:${格式化技能结构转译字段_V1(原始值, '')}`)
        .filter(Boolean)
        .slice(0, 8)
        .join('，');
...
function buildSingleSkillEffectSummary(effect) {
  ...
  switch (原型) {
    ...
    case '状态施加': {
      const 内层摘要 = (Array.isArray(effect.状态效果) ? effect.状态效果 : [])
        ...
        .slice(0, 2)
        .join('；');
      return 转译技能状态施加描述_V1(effect, target) + 持续文本 + (内层摘要 ? '，' + 内层摘要 : '');
    }
    case '状态移除':
    ...
    case '机制授予': {
      ...
      return '使' + target + '获得后续触发权：' + grantText + '，可用' + formatSkillNumber(effect?.可用次数 || 1) + '次';
    }
    case '复制执行':
    ...
    case '召唤生成': {
      ...
      const 召唤物种 = String(effect.召唤物种 || '').trim();
      const 允许继承属性 = 召唤单位允许继承属性_V1(召唤单位类型);
      const 强度文本 = !允许继承属性 && effect.强度 ? '，模板强度约' + formatSkillNumber(effect.强度) : '';
      const 继承文本 = 允许继承属性 && effect.继承属性比例 ? '，继承约' + Math.round(Number(effect.继承属性比例 || 0) * 100) + '%属性' : '';
      return '召唤' + 召唤单位类型 + (召唤物种 && 召唤物种 !== '未指定' ? '/' + 召唤物种 : '') + '【' + String(effect.召唤物名称 || '召唤物') + '】×' + formatSkillNumber(effect.数量 || 1) + 强度文本 + 继承文本 + 持续文本;
    }
    case '场地施加':
  ...
  switch (机甲) {
    ...
    case '无敌金身':
      return '使' + target + '进入无敌金身，神级以下攻击' + (转译技能触发限制_V1(effect.触发限制) || '每日3次') + '豁免';
    case '伤害反射':
...
function buildSkillProductReferenceText(packedEffects) {
  ...
  const visit = effect => {
    ...
    if (String(effect.原型 || '').trim() === '召唤生成') {
      ...
      const 继承比例 = 召唤单位允许继承属性_V1(单位类型) ? Number(effect.继承属性比例 || 0) : 0;
      const 强度 = !召唤单位允许继承属性_V1(单位类型) ? Number(effect.强度 || 0) : 0;
  ...
  if (食物分支) {
    ...
    if (造物 && Array.isArray(造物.使用效果)) {
      造物.使用效果.forEach(效果 => {
        ...
        const 是恢复类 = 原型 === '资源变化' && ['生命', '体力', '魂力', '精神力'].includes(String(效果.资源 || '').trim()) && 正向数值;
        const 是增幅类 = !shouldWrapSkillEffectAsGrant(效果) &&
          ['属性修正', '判定修正', '结算修正', '护盾变化', '修炼速度修正', '成长收益修正'].includes(原型) &&
          正向数值;
        if (!是恢复类 && !是增幅类) return;
        if (Array.isArray(效果.条件分支) && 效果.条件分支.some(分支 => {
          const 条件 = Array.isArray(分支?.条件) ? 分支.条件 : [];
          return 条件.some(条件项 =>
            String(条件项?.类型 || '').trim() === '目标' &&
            String(条件项?.值 || '').trim() === '自身',
          );
        })) return;
        if (是恢复类) {
          效果.条件分支 = [
            ...(Array.isArray(效果.条件分支) ? clonePackedSkillEffects(效果.条件分支) : []),
            {
...
function autoGenerateSkill(
  ...
  if (main === '特殊规则类' && archetype === '召唤') {
    ...
    packedEffects.push({
      原型: '召唤生成',
      目标: '自身',
      召唤单位类型: meta.召唤单位类型 || '魂兽',
      召唤物种: meta.召唤物种 || '未指定魂兽',
      召唤物名称: meta.召唤物名称 || '待命召唤物',
      数量: Math.max(1, Number(meta.召唤数量 || 1)),
      强度: Math.max(0.01, Number(meta.强度 || 1)),
  ...
  if (main === '特殊规则类' && archetype === '机制抹消')
    packedEffects.push({
      原型: '机制抹消',
      目标: normalizedTarget,
      抹消目标: 规范化技能机制抹消目标_V1(mechanismSuppressTarget, '抹消'),
      抹消方式: '移除并封锁',
  ...
  if (main === '特殊规则类' && archetype === '机制窃取') {
    packedEffects.push({
      原型: '机制窃取',
      目标: normalizedTarget,
      窃取目标: 规范化技能机制抹消目标_V1(mechanismStealTarget, '窃取'),
  ...
  const 收口结果 = 收口技能执行结构_V1(生成结果, { 目标模型: 运行目标模型 });
