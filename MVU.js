...
const SKILL_ARCHETYPE_POOL_V1 = {
  ...
  特殊规则类: ['分身', '复制', '反制', '转化', '状态交换', '状态转移', '强制绑定/锁定', '条件触发', '规则改写', '引爆持续伤害', '斩盾', '窃取护盾', '资源夺取', '资源反灌'],
};
...
const SKILL_SECONDARY_BY_MAIN_V1 = {
  ...
  削弱类: ['禁疗', '减速', '迟缓', '标记弱点', '缴械', '驱散增益', '破隐', '治疗反转', '封技', '斩盾', '资源夺取'],
  ...
  特殊规则类: ['共享视野', '标记弱点', '净化', '驱散增益', '窃取增益', '隐身', '护卫', '状态转移', '引爆持续伤害', '斩盾', '窃取护盾', '资源夺取', '资源反灌', '治疗反转', '封技', '无敌金身', '伤害反射', '伤害分摊', '替身抵消', '复苏'],
};
...
const SKILL_SECONDARY_TYPE_BIAS_V1 = {
  ...
  控制系: ['封技', '治疗反转', '目标锁定', '缴械', '驱散增益', '嘲讽', '伤害分摊', '资源夺取'],
  精神系: ['状态转移', '封技', '治疗反转', '窃取增益', '目标锁定', '隐身', '资源夺取', '资源反灌'],
  元素系: ['引爆持续伤害', '斩盾', '封技', '治疗反转', '驱散增益', '破隐', '资源夺取'],
...
function buildSkillBattleSummary(blueprint) {
  ...
  if (['硬控'].includes(archetype)) summary.控制强度 = '硬控';
    ...
    ['软控', '位移限制', '节奏打断', '前摇拉长', '掌控压制', '感知干扰', '幻境', '催眠', '认知扭曲', '资源夺取'].includes(
      archetype,
    ) ||
...
const SKILL_SECONDARY_MECHANIC_TYPES_V1 = {
  ...
  特殊附加: ['窃取增益', '隐身', '嘲讽', '护卫', '状态转移', '窃取护盾', '资源夺取', '资源反灌'],
  代价附加: ['自损', '异常耗蓝', '随机副作用'],
};
