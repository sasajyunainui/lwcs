...
try {
  ...
  const 初始化数据 = {
    ...
    world: { 时间: { tick: 0, _上次结算tick: 0 }, 地点: {}, 动态地点: {}, 时间线: {}, 机密情报: {} },
    char: {
      测试主角: {
  ...
  if (高阶魂骨技能.技能来源 !== '魂骨技能' || 手动魂骨技能.技能来源 !== '魂骨技能') {
    throw new Error('魂骨技能来源未标记为魂骨技能');
  }

  const 普通轮次结果 = Schema.parse({
    ...初始化数据,
    sys: { 玩家名: '测试主角', 系统播报: '非初始化' },
    world: { 时间: { tick: 10, _上次结算tick: 1 }, 地点: {}, 动态地点: {}, 时间线: {}, 机密情报: {} },
    char: {
